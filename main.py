...
def UserForGenre(genero: str):
    ...
    # Realizar un inner join entre genres_df y items_df usando 'item_id' como clave
    merged_df = genres_df2.merge(items_df, on='item_id', how='inner')
    # Realizar otro inner join con games_df usando 'item_id' como clave
